...
exports.TextRendererDebounced = exports.StringRendererDebounced = exports.NumberRendererDebounced = void 0;
...
var _useDebounceValue2 = require("@ui-schema/ui-schema/Utils/useDebounceValue");
...
var StringRendererDebounced = function StringRendererDebounced(_ref) {
  var type = _ref.type,
  ...
  var _useDebounceValue = (0, _useDebounceValue2.useDebounceValue)(value, debounceTime, setter),
      bounceVal = _useDebounceValue.bounceVal,
      setBounceVal = _useDebounceValue.setBounceVal,
      bubbleBounce = _useDebounceValue.bubbleBounce;
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_TextField["default"], {
    ...
    ,
    type: format || (typeof bounceVal.value === 'string' && type === 'number' ? 'text' : type),
    ...
    onClick: onClick,
    onFocus: onFocus,
    onBlur: onBlur ? onBlur : function () {
      bubbleBounce(value);
    },
    onKeyUp: onKeyUp,
    onKeyPress: onKeyPress ? onKeyPress : function (e) {
      return (0, _dsMaterial.forbidInvalidNumber)(e.nativeEvent, schema.get('type'));
    },
    id: 'uis-' + uid,
    style: style,
    onKeyDown: onKeyDown,
...
exports.StringRendererDebounced = StringRendererDebounced;

var TextRendererDebounced = function TextRendererDebounced(_ref2) {
  var schema = _ref2.schema,
      props = (0, _objectWithoutProperties2["default"])(_ref2, _excluded);
  return /*#__PURE__*/_react["default"].createElement(StringRendererDebounced, (0, _extends2["default"])({}, props, {
    schema: schema,
...
exports.TextRendererDebounced = TextRendererDebounced;

var NumberRendererDebounced = function NumberRendererDebounced(props) {
...
exports.NumberRendererDebounced = NumberRendererDebounced;