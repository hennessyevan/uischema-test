...
import { validateMultipleOf, multipleOfValidator, ERROR_MULTIPLE_OF } from '@ui-schema/ui-schema/Validators/MultipleOfValidator';
import { createOrderedMap } from '@ui-schema/ui-schema/Utils';
import { createValidatorErrors } from '@ui-schema/ui-schema/ValidatorErrors';
describe('validateMultipleOf', () => {
  const validateMultipleOfTestValues = [[{
    type: 'number',
    multipleOf: 2
  }, 2, true], [{
    type: 'number',
  ...
  test.each(validateMultipleOfTestValues)('validateMultipleOf(%j, %j) : %s', (schema, value, expected) => {
...
describe('multipleOfValidator', () => {
  const multipleOfValidatorTestValues = [[{
    type: 'number',
    multipleOf: 2
  }, 2, List([ERROR_MULTIPLE_OF, Map({
    multipleOf: 2
  })]), true, false], [{
    type: 'number',
    multipleOf: 2
  }, 3, List([ERROR_MULTIPLE_OF, Map({
    multipleOf: 2
  })]), false, true]];
  test.each(multipleOfValidatorTestValues)('.handle(%j, %s)', (schema, value, error, expectedValid, expectedError) => {
