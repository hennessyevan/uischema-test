...
describe('parseRefs', () => {
  ...
  }, mockDefinitions.get('country')], [OrderedMap({
    '$ref': '#/$defs/country'
  }), {
    defs: OrderedMap({
      country: mockDefinitions.get('country')
  ...
  OrderedMap({
    ...
    allOf: List([mockDefinitions.get('country')])
  })], [
  /*
   * oneOf names must be resolved
   */
  OrderedMap({
    oneOf: List([OrderedMap({
      '$ref': '#/$defs/country'
    })])
  }), {
    defs: OrderedMap({
    ...
    oneOf: List([mockDefinitions.get('country')])
  })], [
  /*
   * anyOf names must be resolved
   */
  OrderedMap({
    anyOf: List([OrderedMap({
      '$ref': '#/$defs/country'
    })])
  }), {
    defs: OrderedMap({
    ...
    anyOf: List([mockDefinitions.get('country')])
  })], [
  /*
  ...
  })]])('parseRefs(%j, %j): %j', (schema, context, expectedSchema) => {
  ...
  })]])('pending: parseRefs(%j, %j): %j', (schema, context, expectedPending) => {
    const res = parseRefs(schema, context);
