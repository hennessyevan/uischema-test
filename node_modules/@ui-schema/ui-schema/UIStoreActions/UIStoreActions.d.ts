...
export declare type UIStoreActionScoped<S extends UIStoreType = UIStoreType, D extends UIStoreUpdaterData = UIStoreUpdaterData> = {
    storeKeys: StoreKeys;
    scopes: (keyof D)[];
...
export declare type UIStoreActionListItemAdd<S extends UIStoreType = UIStoreType, D extends UIStoreUpdaterData = UIStoreUpdaterData> = UIStoreActionListItemAddWithValue<S, D> | UIStoreActionListItemAddWithSchema<S, D>;
...
export declare type UIStoreActions<S extends UIStoreType = UIStoreType, D extends UIStoreUpdaterData = UIStoreUpdaterData> = UIStoreActionListItemAdd<S, D> | UIStoreActionListItemDelete<S, D> | UIStoreActionListItemMove<S, D> | UIStoreActionUpdate<S, D> | UIStoreActionSet<S, D>;
